...
procedure TGridViewForm.FormGesture(Sender: TObject;
...
procedure TGridViewForm.FormKeyDown(Sender: TObject; var Key: Word;
...
procedure TGridViewForm.FormMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
...
procedure TGridViewForm.ShowToolbar(AShow: Boolean);
begin
...
procedure TGridViewForm.ToolbarCloseButtonClick(Sender: TObject);
begin
